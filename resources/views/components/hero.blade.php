<section class="relative isolate flex min-h-[95vh] w-full items-end overflow-hidden">
    ...
    <div class="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 pt-40 lg:px-8">
        ...
        <!-- Search bar -->
        <div class="mt-10 flex w-full max-w-4xl flex-col gap-1 rounded-3xl bg-white p-2 shadow-xl sm:flex-row sm:items-center sm:rounded-full sm:gap-0">
            <!-- Destination -->
            <div class="flex flex-1 items-center gap-3 rounded-full px-5 py-3">
                ...
                <div class="text-left">
                    <span class="block font-body text-xs font-semibold uppercase tracking-wide text-text-primary">Destination</span>
                    <span class="block font-body text-sm text-text-secondary">Where to?</span>
                </div>
            </div>
            ...
            <div class="flex flex-1 items-center gap-3 rounded-full px-5 py-3">
                ...
                <div class="text-left">
                    <span class="block font-body text-xs font-semibold uppercase tracking-wide text-text-primary">Activity</span>
                    <span class="block font-body text-sm text-text-secondary">Trekking</span>
                </div>
            </div>
            ...
            <div class="flex flex-1 items-center gap-3 rounded-full px-5 py-3">
                ...
                <div class="text-left">
                    <span class="block font-body text-xs font-semibold uppercase tracking-wide text-text-primary">When</span>
                    <span class="block font-body text-sm text-text-secondary">Select Date</span>
                </div>
            </div>

            <button type="button" class="mt-1 flex shrink-0 items-center justify-center gap-2 rounded-full bg-primary px-8 py-4 font-body text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-primary/90 sm:mt-0">
                Find Journeys
