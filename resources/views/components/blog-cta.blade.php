<section class="bg-text-primary py-20 sm:py-24">
    <div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
        <h2 class="font-heading text-h3 font-bold text-white sm:text-h2">Your story starts where the road ends.</h2>
        <p class="mt-4 font-body text-sm text-white/70 sm:text-base">
